...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-12 px-4 text-left align-middle font-medium text-slate-600 [&:has([role=checkbox])]:pr-0 dark:text-slate-300',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn('mt-4 text-sm text-slate-600 dark:text-slate-300', className)}
    {...props}
  />
));
